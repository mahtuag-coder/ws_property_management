...
VALUES ('AVAILABLE', (SELECT id FROM address WHERE door_num = '101A'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '202B'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('UNDER_MAINTENANCE', (SELECT id FROM address WHERE door_num = '303C'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '404D'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '505E'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '606F'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '707G'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '808H'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '909I'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('UNDER_MAINTENANCE', (SELECT id FROM address WHERE door_num = '111J'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '112K'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '113L'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '114M'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '115N'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '116O'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '117P'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '118Q'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('UNDER_MAINTENANCE', (SELECT id FROM address WHERE door_num = '119R'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('AVAILABLE', (SELECT id FROM address WHERE door_num = '120S'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM'),
       ('RENTED', (SELECT id FROM address WHERE door_num = '121T'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'SYSTEM', 'SYSTEM');
